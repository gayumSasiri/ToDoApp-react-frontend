...
import {useDispatcher} from "../../context/UserContext.tsx";
import {useTaskDispatcher} from "../../context/TaskContext.tsx";

interface TaskProps {
    handleDelete: React.MouseEventHandler<HTMLElement> | undefined
}

export function Task(task: TaskDTO) {

    const id = useId(); // this hook generates unique id
    ...
    return (
        <div className="Task d-flex justify-content-between align-items-center p-2">
            <div className="d-flex gap-2">
                <input
                    checked={checked ?? false}
                    onChange={handleCheck}
                    id={id} className="form-check-input mx-2" type="checkbox"/>
